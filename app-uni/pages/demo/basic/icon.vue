...
<template>
  <cl-page :padding="20">
    <cl-card label="尺寸">
      <cl-icon name="like" />
      <cl-icon name="like" :size="40" />
      <cl-icon name="like" :size="50" />
    </cl-card>

    <cl-card label="颜色">
      <cl-icon name="like" color="primary" />
      <cl-icon name="like" color="error" />
      <cl-icon name="like" color="success" />
    </cl-card>
