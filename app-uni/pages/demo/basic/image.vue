...
<template>
  <cl-page :padding="20">
    ...
    <cl-card label="自定义大小">
      <cl-row type="flex">
        <cl-image src="/pages/demo/static/avatar1.png" :size="[150, 280]" mode="aspectFill" />
      </cl-row>
    </cl-card>

    <cl-card label="点击预览">
      <cl-row type="flex">
        <cl-image src="/pages/demo/static/bg1.png" :size="140" :preview-list="previewList" />
      </cl-row>
    </cl-card>
