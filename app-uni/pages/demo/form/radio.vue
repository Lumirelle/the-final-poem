...
<template>
  <cl-page :padding="20">
    <cl-card label="基础用法">
      <cl-radio v-model="v1" label="1">
        炸鸡
      </cl-radio>
      <cl-radio v-model="v1" label="2">
        汉堡
      </cl-radio>
      <cl-radio v-model="v1" label="3">
        薯条
      </cl-radio>
      <cl-radio v-model="v1" label="4">
        可乐
      </cl-radio>
      <cl-radio v-model="v1" label="5">
        冰淇淋
      </cl-radio>
    </cl-card>

    <cl-card label="禁用">
      <cl-radio v-model="v3" disabled label="1">
        炸鸡
      </cl-radio>
      <cl-radio v-model="v3" disabled label="2">
        汉堡
      </cl-radio>
    </cl-card>

    <cl-card label="边框">
      <cl-radio v-model="v4" border label="1">
        炸鸡
      </cl-radio>
      <cl-radio v-model="v4" border label="2">
        汉堡
      </cl-radio>
    </cl-card>
