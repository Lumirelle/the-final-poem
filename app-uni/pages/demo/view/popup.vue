...
<template>
  <cl-page :padding="20">
    ...
    <cl-popup v-model="visible_modal" :modal="false" :padding="0">
      <cl-button type="primary" @tap="visible_modal = false">
        点我关闭
      </cl-button>
    </cl-popup>
    ...
    <cl-card label="不显示遮罩层">
      <cl-button @tap="visible_modal = true">
        打开
      </cl-button>
    </cl-card>

    <cl-card label="添加样式">
      <cl-button @tap="visible_custom = true">
        打开
      </cl-button>
    </cl-card>

    <cl-card label="方向">
      <cl-button @tap="visible_left = true">
        左边
      </cl-button>
      <cl-button @tap="visible_top = true">
        上边
      </cl-button>
      <cl-button @tap="visible_right = true">
        右边
      </cl-button>
      <cl-button @tap="visible_bottom = true">
        下边
      </cl-button>
    </cl-card>
  </cl-page>
